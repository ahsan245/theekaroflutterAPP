...
class OTPEmailVerifyPage extends StatefulWidget {
  final String? email;
  final String? otpHash;

  OTPEmailVerifyPage({this.email, this.otpHash});

  @override
  _OTPEmailVerifyPageState createState() => _OTPEmailVerifyPageState();
}

class _OTPEmailVerifyPageState extends State<OTPEmailVerifyPage> {
  ...
  Widget otpVerify() {
    return Column(
      ...
      children: [
        ...
        Center(
          child: Text(
            "Enter OTP code sent to you Email \n${widget.email}",
            maxLines: 2,
